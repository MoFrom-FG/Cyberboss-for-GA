...
const checkinConfigEvents = new EventEmitter();
checkinConfigEvents.setMaxListeners(50);
...
class CheckinConfigStore {
  ...
  setRange(range) {
    ...
    this.save();
    checkinConfigEvents.emit("rangeChanged", {
...
function onCheckinRangeChanged(listener) {
  if (typeof listener !== "function") {
    return () => {};
  }
  checkinConfigEvents.on("rangeChanged", listener);
  return () => checkinConfigEvents.off("rangeChanged", listener);
}
